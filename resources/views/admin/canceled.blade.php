...
<section class="content-header">
  <h1>
    ...
    @if (count($canceledData) > 0)
      <a href="{{ route('canceledOnlineData') }}" class="btn btn-success float-right">Download Excell</a>
    @endif
  </h1>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Online Failed Orders</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example2" class="table table-bordered table-striped">
            ...
            @foreach ($canceledData as $single_data)
	            <tr>
	              <td>{{ $loop->index + 1 }}</td>
