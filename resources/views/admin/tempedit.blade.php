  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="{{ route('tempreg.update',$data->id) }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
          {{method_field('PATCH')}}
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-xs-6">
                    ...
                    <input type="text" value="{{ $data->mobile_1 }}" class="form-control" id="contact" placeholder="+880 XXXX XXX XXX" name="mobile_1" required="">
              </div>
              <div class="col-xs-6">
            ...
            <strong>15<sup>th</sup>February 2019 (Day 02)</strong>
                ...
                <!-- radio -->
{{--                 <div class="form-group">
                  <input type="text" readonly="" name="payment_method" value="{{ $data->payment_method }}">

                  <div class="radio">
                    <label for="online">
                      <input type="radio" name="payment_method" id="online" value="online" {{ ($data->payment_method == 'online') ? 'checked' : '' }} disabled="">
                      Online
                    </label>
                  </div>
