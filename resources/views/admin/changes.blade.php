...
<section class="content-header">
  <h1>
    ...
    @if (count($alldata) > 0)
     <a href="{{ route('changesData') }}" class="btn btn-success float-right">Download Excell</a>
    @endif
  </h1>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">ALL Changes Done By admin</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            @foreach ($alldata as $single_data)
                ...
                <td>{{ $single_data->order_id }}</td>
	              <td>{{ $single_data->admin_name }}</td>
                <td>{!! $single_data->getParsedOldData() !!}</td>
                <td>{!! $single_data->getParsedNewData() !!}</td>
