...
<section class="content-header">
  <h1>
    ...
    @if (count($alldata) > 0)
      <a href="{{ route('pendingBankData') }}" class="btn btn-success float-right">Download Excell</a>
    @endif
  </h1>
</section>
            ...
            @foreach ($alldata as $single_data)
              <tr>
                ...
                <td>
                  ...
                  <a href="{{ route('tempreg.edit',$single_data->id) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
