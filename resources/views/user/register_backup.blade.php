    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function totalPayable() {
                var a = checkGraduationYear() / 100 * (1e3 + 100 * $("#d1la").val() + 300 * $("#d1da").val() + 300 *
                    $("#d2la").val() + 700 * $("#d2da").val() + 300 * $("#d2dda").val());
            ...
            $("#graduation").on("keyup", function() {
                ...
                roundNumber(this.files[0].size / 1024 / 1024, 2) > 2 ? $("#imagesize").html(
                    '<span class="sbh_bg">File size Exceeds 2 MB<br> Please choose a file under 2MB</span>'
