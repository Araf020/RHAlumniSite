		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="credential text-sm-center bg_w">
					<p>
						Please pay total <strong>{{ $data->total_amount}} taka </strong> to <strong>Sonali Bank BUET Branch</strong>, Account No: <strong>4404034068519</strong>.<br>
						After Paying please visit the website and fill the <strong>Bank Payment Verify</strong> option.<br>
						After Successful verification of transaction you will receive a Registration Confirmation message and email.
					</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message last">
					<p>If you have any problem or query, then send an email to <span>sbhaa.buet@gmail.com</span>
					<br>
					<p>Have a good day.</p>
