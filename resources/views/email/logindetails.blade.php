		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message">
					<p>Hi <span>Xatta</span>,<br>Thank you for signing up with PL Tutorials! We hope you enjoy your time with us. Your login details are given below.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message last">
					<p>If you have any problem or query, then send an email to <span>pltutorialsbuet@gmail.com</span> or just reply to this email. We are always happy to help you out.<br>If the login button is not working then click on 
					<br>
					<p>Cheers</p>
