		...
		<div class="row">
			<div class="col-12 col-sm-10 col-md-6 mx-auto">
				<div class="main_message">
					<p>Hi <span>{{ $data->name }}</span>,<br>since you have registerd more than 1 hour ago but not paid the money.<br>That is why your data has been deleted from the database and now you can again register for the programe.</p>
