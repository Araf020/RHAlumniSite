...
class DeleteFailedTransaction extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sbhaa:deletefailedtransaction';
     ...
     * @var string
     */
    protected $description = 'Removes Failed Transaction of more than 6 hours.';
